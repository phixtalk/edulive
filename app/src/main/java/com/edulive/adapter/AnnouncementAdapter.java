...
public class AnnouncementAdapter extends BaseAdapter implements Filterable {
    ...
    public AnnouncementAdapter(Activity activity, List<FeedItem> feedItems, String viewType) {
    ...
    private void performAction(String action, String courseId, String memberId) {
        ...
        try {
            String link = activity.getResources().getString(R.string.base_url).concat("api/announceaction");

            Map<String, String> postParam= new HashMap<String, String>();

            postParam.put("courseid", courseId);
            postParam.put("coursename", "");
            postParam.put("description","");
            postParam.put("action","deletecourse");
