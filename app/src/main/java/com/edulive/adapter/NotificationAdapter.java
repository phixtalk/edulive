...
public class NotificationAdapter extends BaseAdapter implements Filterable {
    ...
    public NotificationAdapter(Activity activity, List<FeedItem> feedItems, String userId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        created_by.setText("Sent On: "+item.getDateJoined());
        description.setVisibility(View.GONE);
        if(item.getShowIdentity().equals("1")){//message has been read
